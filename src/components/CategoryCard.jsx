  ...
  return (
    <div className={`category-card ${disabled ? 'disabled' : ''}`}>
      <div className="category-header">
        ...
        <span className="category-metric">{category.metric} {category.imperial?.replaceUnit ? `(${category.imperial.unit})` : `${category.unit}${category.imperial ? ` (${category.imperial.unit})` : ''}`}</span>
      </div>

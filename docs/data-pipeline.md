...
The `validate.test.js` suite (84 tests) specifically validates the generated JSON against the YAML sources — it catches mismatches, missing materials, and incorrect RSI calculations.
